...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        "Create FBANK feature files with frequency and time masks.\n"
        "Usage:  compute-fbank-feats-masks [options...] <wav-rspecifier> <feats-wspecifier>\n";
    ...
    for (; !reader.Done(); reader.Next()) {
      ...
      try { 
        fbank.ComputeFeaturesMask(waveform, wave_data.SampFreq(), vtln_warp_local, F,T,mF,mT, &features);
      } catch (...) {
